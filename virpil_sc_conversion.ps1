...
$labelXML.Text = "Select a star citizen xml input file and click generate to create a new file updated with buttons mapping of VIRPIL Controls Configurator"
$form.Controls.Add($labelXML)

$btnXML.Add_Click({
    $dialog = New-Object System.Windows.Forms.OpenFileDialog
    $dialog.Filter = "Fichiers XML (*.xml)|*.xml"
    $dialog.Title = "Select Star citizen input XML file"
...
$btnOK.Add_Click({
	...
	$saveDialog.Title = "Where do you want to save new Star Citizen XML input file?"
